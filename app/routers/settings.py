...
DB_LABELS = {"sqlite": "SQLite", "postgresql": "PostgreSQL", "mysql": "MySQL"}
...
def get_settings(db: Session = Depends(get_db)):
    ...
    return {
        ...
        # 接続先の種類だけ返す（接続文字列はパスワードを含むため返さない）
        "database": DB_LABELS.get(engine.dialect.name, engine.dialect.name),
