...
def auto_assign_staff(body: AutoAssignRequest | None = None, db: Session = Depends(get_db)):
    ...
    for session in sessions:
        ...
        TRAVEL_BUFFER = timedelta(minutes=10)  # 別部屋間の移動に必要な最低時間
        ...
        if effective_required >= 2 and assigned_count < effective_required:
